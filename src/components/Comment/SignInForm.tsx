        ...
        <Form {...form}>
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white p-12 rounded-lg shadow-lg w-full max-w-md">
              ...
              <div className="mx-auto my-4 flex w-full items-center justify-evenly before:mr-4 before:block before:h-px  before:bg-stone-400 after:ml-4 after:block after:h-px  after:bg-stone-400 text-gray-400">
                OR
              </div>
